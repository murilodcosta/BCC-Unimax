...
public class Dijkstra {
    ...
    // Novo método para exibir resultado
    public static void exibirResultadoEstacoes(String origem, String destino, Resultado resultado) {
        System.out.println("\n" + "=".repeat(60));
        System.out.println("PROBLEMA: Trajeto estações Metro");
        System.out.println("Caminho Mais Curto");
        System.out.println("=".repeat(60));
        System.out.println("\nEstação de: " + origem);
        System.out.println("Para: " + destino);
        
        // Formata a lista do caminho
        System.out.println("Melhor rota: " + String.join(" → ", resultado.getCaminho()));
        
        // Ajustado para "min"
        System.out.printf("Distância total: %.1f min\n", resultado.getDistancia());
        System.out.println("=".repeat(60) + "\n");
    }
}