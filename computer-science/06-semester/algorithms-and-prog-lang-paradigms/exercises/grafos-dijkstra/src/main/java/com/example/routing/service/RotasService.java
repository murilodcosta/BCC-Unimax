...
public class RotasService {
    ...
    // Novo método exercício Metrô
    public void exercicioAula13_Metro() {
        Grafo mapa = new Grafo();
        // tratando a matriz CSV como um grafo NÃO-DIRECIONADO (bidirecional) para que
        // seja possível alcançar o tempo de 38.0 min

        mapa.adicionarRua("AT", "AL", 10);
        mapa.adicionarRua("AT", "AJ", 45);
        mapa.adicionarRua("AT", "AS", 25);
        mapa.adicionarRua("AT", "VS", 25);

        mapa.adicionarRua("AL", "AJ", 42);
        mapa.adicionarRua("AL", "AS", 3);
        mapa.adicionarRua("AL", "VS", 3);

        mapa.adicionarRua("AJ", "AS", 25);
        mapa.adicionarRua("AJ", "VI", 80);
        mapa.adicionarRua("AJ", "VS", 12);

        mapa.adicionarRua("AS", "VI", 81);
        mapa.adicionarRua("AS", "VB", 14);
        mapa.adicionarRua("AS", "VP", 25);

        mapa.adicionarRua("VI", "VS", 81);
        mapa.adicionarRua("VI", "VB", 120);
        mapa.adicionarRua("VI", "VP", 10);

        mapa.adicionarRua("VS", "VB", 18);
        mapa.adicionarRua("VS", "VP", 26);

        mapa.adicionarRua("VB", "VP", 22);

        // Imprimir a estrutura do grafo
        System.out.println("\n" + "=".repeat(60));
        System.out.println("ESTRUTURA DO GRAFO (Metro)");
        ...
        // Exibir resultado
        Dijkstra.exibirResultadoEstacoes(origem, destino, resultado);
    }
}