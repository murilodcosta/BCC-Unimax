  ...
  return (
    <>
      <div className="z-10 w-full max-w-xl px-5 xl:px-0">
        ...
        >
          O futuro do diagnóstico na palma da sua mão
        </h1>
        <p
          className="mt-6 animate-fade-up text-center text-gray-500 opacity-0 [text-wrap:balance] md:text-xl"
          style={{ animationDelay: "0.25s", animationFillMode: "forwards" }}
        >
          Seu assistente em diagnósticos por imagem. Integre nossa IA para uma triagem eficiente e identificação de padrões, 
          liberando seu tempo para decisões clínicas complexas.
        </p>
        <div
